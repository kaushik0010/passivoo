...
import { Loader2, Ticket, ShieldAlert, Sparkles, Crown } from "lucide-react";
...
export function LoginForm({ activeEvent }: LoginFormProps) {
        ...
        <form action={formAction} className="space-y-5">
          ...
          {/* <div className="text-right">
            <Link 
              ...
              className="text-xs text-slate-500 hover:text-amber-500 transition-colors font-medium"
            >
              Forgot password?
            </Link>
          </div> */}
